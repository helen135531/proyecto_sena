   ...
   if(isset($_GET['get_id'])){
      ...
      if($get_product->rowCount() > 0){
         while($fetch_p = $get_product->fetch(PDO::FETCH_ASSOC)){
            $insert_order = $conn->prepare("INSERT INTO `ordenes`(id, user_id, name, number, email, address, address_type, method, product_id, price, qty) VALUES(?,?,?,?,?,?,?,?,?,?,?)");
...
<section class="checkout">
   ...
   <h1 class="heading">resumen de pago</h1>
   ...
   <div class="row">
         ...
         <div class="flex">
            <div class="box">
               ...
               <select name="method" class="input" required>
                  ...
                  <option value="net banking">banca neta</option>
      ...
      <div class="summary">
         <h3 class="title">artículos del carrito</h3>
         <?php
            $grand_total = 0;
            if(isset($_GET['get_id'])){
         ...
         ?>
         <div class="grand-total"><span>gran total :</span><p>$ <?= $grand_total; ?></p></div>
      </div>
